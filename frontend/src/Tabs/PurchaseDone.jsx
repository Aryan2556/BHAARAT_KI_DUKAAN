...
import { ArrowRight, CheckCircle, FileBarChart, FileDownIcon, HandHeart } from "lucide-react";
...
const PurchaseDone = () => {
	...
	useEffect(() => {
		...
		const newDate = addDays(currentDate, 4);
			...
			<div className='max-w-md w-full bg-gray-800 rounded-lg shadow-xl overflow-hidden relative z-10'>
				<div className='p-6 sm:p-8'>
					...
					<h1 className='text-2xl sm:text-3xl font-bold text-center text-emerald-400 mb-2'>
						Purchase Successfull !<br /> <span className='whitespace-nowrap text-lg'>Your Order will be delivered soon ..</span>
					</h1>
					...
					<div className='bg-gray-700 rounded-lg p-4 mb-6'>
						...
						<div className='flex items-center justify-between'>
							...
							<span className='text-sm font-semibold text-emerald-400'> {futureDate.toDateString()}</span>
						</div>
					</div>
