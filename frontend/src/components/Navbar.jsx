        ...
        <div className='flex flex-wrap justify-between items-center'>
          ...
          <div className="absolute top-full left-0 w-full bg-gray-800 p-4 md:hidden">
            <div className="flex flex-col gap-y-2">
              ...
              {user && (
                <Link to="/cart" className='relative group text-gray=300 hover:text-green transition duration=300 ease-in-out'>
              ...
              {Admin && (
                <Link to="/secret-dashboard" className='bg-green hover:bg-dark-green text-white px=.3 py=.1 rounded-md font-medium transition duration=.3 ease-in-out flex items-center'>
                  Dashboard
                </Link>
              )}
              ...
              {user ? (
                ...
                <>
                  <Link to="/signup" className='bg-emerald-600 w-fit hover:bg-green-600 text-white py-2 px-4 rounded-md flex items-center transition duration-300 ease-in-out'>
                    <UserPlus className='mr-2' size={15} />
                    Sign Up
                  </Link>
                  <Link to="/login" className='bg-gray-700 hover:bg-gray-600 text-white py-2 px-4 rounded-md flex items-center transition duration-300 w-fit ease-in-out'>
